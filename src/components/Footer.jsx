      ...
      <footer className='bg-black text-white'>
        <div className=' container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
          <div className=' w-64  md:mx-0 mx-auto text-center md:text-left'>
            <h3 className='font-bold text-2xl'>Amaze<span className='text-[red]'>Shop</span></h3>
          </div>
          <div className='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center'>
            ...
            <div className='lg:w-1/4 md:w-1/2 w-full px-4'>
              ...
              <li className='mt-1'>+1236541366</li>
                <li className='mt-1'>News Blog</li>
        ...
        <div className='bg-[red] text-white w-full flex justify-between '>
              <div className='w-[100%] container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
                <p className=' text-sm text-center sm:text-left'>ⓒ 2024 AmazeShop-<span>@copyright</span></p>
                <p className=' inline-flex sm:ml-auto sm:mt-0 mt-2 sm:justify-start'>
              <span className='mr-3'><FaFacebook size={30}/></span>
              <span className='mr-4'><AiFillInstagram size={30} /></span>
              <span className='mr-6'><IoLogoTwitter size={30} /></span>
                </p>
              </div>
            </div>
      </footer>
