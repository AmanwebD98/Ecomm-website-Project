...
const SinglePage = ({Addtocart}) => {
   ...
   const [singleProduct,SetsingleProduct]= useState([])
    ...
    const AddtosingleProduct = () => {
        Addtocart(AddtosingleProduct)
       toast.success('Product is added to cart')
    }

   const AllproductsNavi = useNavigate();

    return (
        <>
            <div>
               <IoArrowBackSharp size={50} onClick={() => AllproductsNavi('/AllProducts')} className='absolute left-[60px] top-[120px]'  />
                <section className="text-gray-600 body-font overflow-hidden h-[90vh] flex items-center">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={singleProduct.thumbnail} />
            ...
            <a className="text-gray-500">
              <svg fill="currentColor"  className="w-5 h-5" viewBox="0 0 24 24">
                <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
                                ...
                                <p className="leading-relaxed mb-3">{singleProduct.description}</p>
        
        <div className="flex">
                                    <span className="title-font font-medium text-2xl text-gray-900"> ${singleProduct.price }</span>
          <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={AddtosingleProduct}>Add to cart</button>
